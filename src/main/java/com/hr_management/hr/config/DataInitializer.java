...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        createDefaultUserAndEmployee("admin", "admin@example.com", "admin123", Role.ADMIN, "Admin", "User", "Administration", "System Administrator");
        createDefaultUserAndEmployee("hrmanager", "hr@example.com", "hrmanager123", Role.HR_MANAGER, "HR", "Manager", "Human Resources", "HR Manager");
        ...
        for (User user : allUsers) {
            if (!employeeRepository.existsByUser(user)) {
                ...
                createEmployeeForUser(user, "DefaultFirst", "DefaultLast", "DefaultDept", "DefaultPos"); 
            }
        }
        */
    ...
    private void createDefaultUserAndEmployee(String username, String email, String password, Role role, 
        ...
        if (existingUserOpt.isEmpty()) {
            ...
            createEmployeeForUser(savedUser, firstName, lastName, department, position);
        } else {
            ...
            if (!employeeRepository.existsByUser(existingUser)) {
                ...
                createEmployeeForUser(existingUser, firstName, lastName, department, position);
            }
        }
    }

    private void createEmployeeForUser(User user, String firstName, String lastName, String department, String position) {
        if (user == null) {
